...
class Default_controller extends CI_Controller {
	...
	//Dashboard utk cookie
	public function dashboardadmincookie(){

		// $this->cekloginadmin();
		echo 'data '.$this->input->post('username');
		$this->create_cookie_encrypt("adminCookie",'firmanhidup');
		// $this->load->view('admin/dashboard');
	}
	...
	public function test_email(){
		...
		$user = 'confirmation inbox';
		$pass = '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';
		...
		$params = array(
			...
			'api_key'   => $pass,
			'to'        => $email,
			'subject'   => 'Balasan Video Pada Ruang Doa',
			'html'      => '<p> Anda mendapatkan balasan video pada Ruang Doa oleh Admin. Silahkan mengecek aplikasi Firman Hidup Anda.. Terima Kasih </p>',
			'text'      => 'the plain text',
			'from'      => 'admin@cmcsurabaya.org',
